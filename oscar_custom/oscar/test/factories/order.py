...
from oscar_custom.oscar.test import factories
from oscar_custom.oscar.test.factories.utils import tax_add, tax_subtract
...
class BillingAddressFactory(factory.django.DjangoModelFactory):
    country = factory.SubFactory("oscar_custom.oscar.test.factories.CountryFactory")
...
class OrderFactory(factory.django.DjangoModelFactory):
    ...
    basket = factory.SubFactory("oscar_custom.oscar.test.factories.BasketFactory")
...
class OrderLineFactory(factory.django.DjangoModelFactory):
    ...
    product = factory.SubFactory("oscar_custom.oscar.test.factories.ProductFactory")
