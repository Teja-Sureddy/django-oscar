...
from oscar_custom.oscar.core.exceptions import (
    AppNotFoundError,
    ClassNotFoundError,
)
from oscar_custom.oscar.utils.deprecation import RemovedInOscar32Warning
...
def get_class(module_label, classname, module_prefix="oscar_custom.oscar.apps"):
    """
...
def get_classes(module_label, classnames, module_prefix="oscar_custom.oscar.apps"):
