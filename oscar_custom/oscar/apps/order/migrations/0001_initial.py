    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postcode', oscar_custom.oscar.models.fields.UppercaseCharField(max_length=64, verbose_name='Post/Zip-code', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postcode', oscar_custom.oscar.models.fields.UppercaseCharField(max_length=64, verbose_name='Post/Zip-code', blank=True)),
                ('search_text', models.TextField(editable=False, verbose_name='Search text - used only for searching addresses')),
                ('phone_number', oscar_custom.oscar.models.fields.PhoneNumberField(verbose_name='Phone number', help_text='In case we need to call you about your order', blank=True)),
