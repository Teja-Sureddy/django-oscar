...
from oscar_custom.oscar.apps.order.signals import order_line_status_changed, order_status_changed
from oscar_custom.oscar.apps.partner.exceptions import InvalidStockAdjustment
from oscar_custom.oscar.core.compat import AUTH_USER_MODEL
from oscar_custom.oscar.core.loading import get_model
from oscar_custom.oscar.core.utils import get_default_currency
from oscar_custom.oscar.models.fields import AutoSlugField

from . import exceptions

logger = logging.getLogger("oscar_custom.oscar.order")
...
class AbstractOrder(models.Model):
    ...
    def verification_hash(self):
        signer = Signer(salt="oscar_custom.oscar.apps.order.Order")
