...
from oscar_custom.oscar.core.application import OscarDashboardConfig
from oscar_custom.oscar.views.decorators import check_permissions

logger = logging.getLogger("oscar_custom.oscar.dashboard")
