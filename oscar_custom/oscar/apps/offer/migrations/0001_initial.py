    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', oscar_custom.oscar.models.fields.PositiveDecimalField(max_digits=12, decimal_places=2, blank=True, verbose_name='Value', null=True)),
                ...
                ('proxy_class', oscar_custom.oscar.models.fields.NullCharField(unique=True, verbose_name='Custom class', default=None, max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('redirect_url', oscar_custom.oscar.models.fields.ExtendedURLField(verbose_name='URL redirect (optional)', blank=True)),
