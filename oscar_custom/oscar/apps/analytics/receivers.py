...
from oscar_custom.oscar.apps.basket.signals import basket_addition
from oscar_custom.oscar.apps.catalogue.signals import product_viewed
from oscar_custom.oscar.apps.order.signals import order_placed
from oscar_custom.oscar.apps.search.signals import user_search
...
logger = logging.getLogger("oscar_custom.oscar.analytics")
